...
<body class="bg-dark">
	...
	try {
		...
		PreparedStatement ps=con.prepareStatement("select hodid,name,year,semester,branch,phno,email from hod;");
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="col text-center">
							<h2 class="display-4 text-light text-capitalize">-- List of HOD details --</h2>
							<br> <br>
						</div>
					</div>
					<div class="row d-flex justify-content-center">
					...
					<div class="row d-flex justify-content-center mt-4">
						<div class="col-md-10">
							...
							<tr> <td>Hod ID</td><td>Name</td><td>Year</td><td>Semester</td><td>Branch</td><td>Phone No.</td><td>Email</td> </tr>
							<%
							while(rs.next()){
